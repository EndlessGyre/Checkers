...
// Starting game state data
const board = [null, 0, null, 1, null, 2, null, 3, null, 4,
  null, 5, null, 6, null, 7, null, 8, null, 9, null, 10, null, 11, null,
null, null, null, null, null, null, null, null, null, null, null,
null, null, null, null, 12, null, 13, null, 14, null,
...
//console.log('Length of redsPieces is ' + redsPieces.length);

function givePiecesEventListeners(){
  if(turn){
    for(let i = 0; i < redsPieces.length; i++){
      redsPieces[i].addEventListener("click", getPlayerPieces);
      //console.log('RedLoops: ' + parseInt(i + 1));
    }
  }else{
    for(let i = 0; i < blacksPieces.length; i++){
      blacksPieces[i].addEventListener("click", getPlayerPieces);
      console.log('BlackLoops: ' + parseInt(i + 1));
    }
  }
}

function getPlayerPieces(){
  //console.log('getPlayerPieces is invoked!');
  if(turn){
...
function resetSelectedPieceProperties(){
  ...
  //console.log('resetSelectedPieceProperties is invoked!');
}

function getSelectedPiece(){
  selectedPiece.pieceId = parseInt(event.target.id);
  selectedPiece.indexOfBoardPiece = findPiece(selectedPiece.pieceId);
  //console.log('getSelectedPiece is invoked!');
  isPieceKing();  
}
...
function isPieceKing(){
  ...
  //console.log(selectedPiece.isKing);
  getAvailableSpaces();
}
...
function getAvailableSpaces(){
  ...
  console.log('getAvailableJumpSpaces is invoked!\nselectedPiece.minusNinthSpace = ' + selectedPiece.minusNinthSpace);
...
function giveCellsClick(){
  console.log('givecellsclick invoked');
...
function checkForWin(){
  if(blackScore === 0){
    ...
    divider.style.display = 'none';
    for(let i = 0; i < blackTurnText.length; i_++){
